...
public:
        UtilsStd() {}
	int pos(string substr, string s, unsigned int offset = 0);
	int pos(char ch, string s, unsigned int offset = 0);
	string intToStr(int x, bool addZero = false);
	...
	int write(string s, string filename, int mode = 0);
