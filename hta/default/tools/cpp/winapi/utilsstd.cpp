...
int UtilsStd::pos(string substr, string s, unsigned int offset)
{
	bool f = false;
	int rez = -1;
	unsigned int subsz = substr.length();
...
//-----------------------------------------------------------------------
string UtilsStd::intToStr(int x, bool addZero)
{
	int srcX = x;
	string r = "";
	if (x == 0) {
...
//----------------------------------------
int UtilsStd::pos(char ch, string s, unsigned int offset)
{
	int res = -1;
...
//-------------------------------------------------------
int UtilsStd :: write(string s, string filename, int mode)
{
  unsigned int i, sz = 0;
  /*char* path = new char [filename.length()+1];
  for ( i = 0; i < filename.length(); i++)
